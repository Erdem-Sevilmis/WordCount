...
class WordCountTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"Word word word"})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"123 123 word 123", "1Word 2word word 3word", "Word1 word2 word3 word", "Word w1ord wo2rd word3"})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"Word word word       ","        Word word word", "Word      word     word     "})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"Word. word& word", "!Word word word$", "word W§§ord", "W$ord §$ word"})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"     Wo2rd.     wod& word    ", "   !Word word word4", "   wo1r§d    word W§§ord         ", "W$ord         §$ word         "})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"src/main/resources/test.txt"})
