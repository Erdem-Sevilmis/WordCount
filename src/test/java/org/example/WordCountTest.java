...
class WordCountTest {
    ...
    void getWordWithSingleWord(String phrase) {
        ...
        assertEquals(new WordCountResult(1, 1), wc.getWordCount());
    }
    ...
    void getWordWithMultipleWords(String phrase) {
        WordCount wc = new WordCount(phrase);
        assertEquals(new WordCountResult(3, 2), wc.getWordCount());
    }
    ...
    void getWordWithStopWords(String phrase) {
        WordCount wc = new WordCount(phrase);
        assertEquals(new WordCountResult(0, 0), wc.getWordCount());
    }
    ...
    void getUniqueWordCount(String phrase) {
        WordCount wc = new WordCount(phrase);
        assertEquals(new WordCountResult(9, 7), wc.getWordCount());
    }
